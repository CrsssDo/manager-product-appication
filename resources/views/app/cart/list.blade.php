...
@section('content')
    <form class="bg0 p-t-130 p-b-85" method="post" action="/app/order">
        @if (count($products) != 0)
            <div class="container">
                <div class="row">
                    <div class="col-lg-10 col-xl-7 m-lr-auto m-b-50">
                        <div class="m-l-25 m-r--38 m-lr-0-xl">
                                        ...
                                        <tr class="table_row">
                                            <td class="column-1">
                                                <div class="how-itemcart1">
                                                    <img src="/template/images/{{ $product->image_url }}" alt="IMG">
                                                </div>
                                            </td>
                                            ...
                                            <td class="column-5">{{ number_format($product->price, 0, '', '.') }}</td>
                                            <td class="p-r-15">
                                                <a href="/app/cart/delete/{{ $product->id }}">Xóa</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                            ...
                            <div class="flex-w flex-sb-m bor15 p-t-18 p-b-15 p-lr-40 p-lr-15-sm">
                                ...
                                <button type="submit" value="Update Cart" formaction="/app/update-cart"
